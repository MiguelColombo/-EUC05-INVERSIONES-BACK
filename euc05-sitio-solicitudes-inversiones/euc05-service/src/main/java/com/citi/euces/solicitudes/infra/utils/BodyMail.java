...
public class BodyMail {
     ...
     public String BodySolicitudAutorizadorUEC(Timestamp fecha_solic, String Folio_BancaNet, String TIPO_AUTORI, Integer oferta, 
 			String JUSTIFICACION, String NOMEJEC, String NOM_CTE, Long NUM_CTE, Long CONTRATO, String MONTO, int PLAZO,
 		...
 		System.out.println("288 title y Folio_BancaNet->" + Folio_BancaNet);
 		System.out.println("288 title y Folio_BancaNet != null->" + Folio_BancaNet != null);
 		if (oferta == 5  && Folio_BancaNet != null) {
 		...
 		body = "<html xmlns =\"http://www.w3.org/1999/xhtml\">"
 				...
 				+ "<tr> <td style='background-color:#FFFFFF;text-align:center;color:#1F497D;font-size:8pt'><b> " + suc
 				+ "</b></td></tr>"
 				...
 				+ "<tr> <td style='background-color:#FFFFFF;text-align:center;color:#1F497D;font-size:8pt'><b> " + PLAZO
 				+ "</b> </td></tr>"
     ...
     public String BodySolicitud(Timestamp fecha_solic, String Folio_BancaNet, String TIPO_AUTORI, Integer oferta, String JUSTIFICACION,
 			String NOMEJEC, String NOM_CTE, Long NUM_CTE, Long CONTRATO, String MONTO, int PLAZO, String TASA_AUTORI,
 			String idtasaEncrypt, String strAceptada, String strRechadaza, String suc, String nombre_autorizador,
 			String soeidEncrypt, String urlRedirect, String linksAutoriza, String linksRechazas)
 		...
 		body = "<html xmlns =\"http://www.w3.org/1999/xhtml\">"
 				...
 				+ "<tr> <td align='center' style='text-align:center;font-size:8pt'>" + "  <a href = '" + urlRedirect
 				+ "?data=" + linksAutoriza
