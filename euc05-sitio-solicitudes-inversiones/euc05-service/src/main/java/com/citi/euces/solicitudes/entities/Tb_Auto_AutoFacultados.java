...
@Entity
@Table(name = "UEC_TB_AUTO_AUTOFACULTADOS")
public class Tb_Auto_AutoFacultados {
	 ...
	 * @param is_campesp
	 */
	public Tb_Auto_AutoFacultados(String soeid, String soeid_Divisional, String soeid_Regional, String division,
			String nombre, String inic, String fecha_Inicio, String fecha_Termino, Long alta, String correo,
			String region, Long is_cetes100, Long is_campesp) {
		super();
		Soeid = soeid;
